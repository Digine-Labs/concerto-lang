...
impl Type {
    ...
    pub fn from_name(name: &str) -> Self {
        match name {
            ...
            "ModelRef" => Type::ModelRef,
            "Agent" | "AgentRef" => Type::AgentRef,
            "HashMapRef" => Type::HashMapRef,
            "Ledger" | "LedgerRef" => Type::LedgerRef,
            "Memory" | "MemoryRef" => Type::MemoryRef,
            "Any" => Type::Any,
    ...
    pub fn display_name(&self) -> std::string::String {
        match self {
            ...
            Type::ModelRef => "ModelRef".into(),
            Type::AgentRef => "AgentRef".into(),
            Type::HashMapRef => "HashMapRef".into(),
            Type::LedgerRef => "LedgerRef".into(),
            Type::MemoryRef => "MemoryRef".into(),
